...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew15_5_main      
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:  28.74   6.25   0.06   0.04   4.72   6.23   0.34   0.13
 penetration..:  10.84   2.31  24.10   8.10  16.54   7.63  26.59   6.57
 collim scatt.:   5.64   1.25   9.69   2.98  11.18   3.97   9.00   2.32
 collim x-rays:   0.00   0.00   0.00   0.00   3.23   1.56   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 305.2          
 MaxValue projection: 0.4364E-01     
 CountRate spectrum.: 762.2          
 CountRate E-Window.: 80.29          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.23 %          35.10 %
 Penetration........:  62.39 %          45.34 %
 Scatter in collim..:  23.94 %          19.56 %
 X-rays in collim...:   2.45 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  43.04 %   0.00 %
...
------------------------------------------------------------------------------
 ...
 Scatter order 1....: 84.71 %        
 Scatter order 2....: 13.23 %        
 Scatter order 3....: 1.81 %         
 Scatter order 4....: 0.25 %         
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0442         
 Efficiency spectrum: 0.4196         
 Sensitivity Cps/MBq: 80.2892        
 Sensitivity Cpm/uCi: 178.2421       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:25 06:31:18
 Simulation stopped.: 2024:04:25 16:54:27
 Elapsed time.......: 10 h, 23 m and 9 s
 DetectorHits.......: 4635487        
 DetectorHits/CPUsec: 326            
------------------------------------------------------------------------------
 ...
 Header file: mew15_5_main.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia mew15_5_main/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:170.925/21:147.075/bg:0.2
