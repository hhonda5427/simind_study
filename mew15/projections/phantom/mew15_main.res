...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew15_main        
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:  28.77   6.26   0.06   0.04   4.72   6.23   0.34   0.13
 penetration..:  10.86   2.34  24.09   8.08  16.55   7.61  26.58   6.58
 collim scatt.:   5.63   1.26   9.63   2.99  11.18   3.98   8.98   2.33
 collim x-rays:   0.00   0.00   0.00   0.00   3.22   1.57   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 303.9          
 MaxValue projection: 0.4830E-01     
 CountRate spectrum.: 762.4          
 CountRate E-Window.: 80.23          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.22 %          35.13 %
 Penetration........:  62.37 %          45.37 %
 Scatter in collim..:  23.96 %          19.49 %
 X-rays in collim...:   2.45 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  43.01 %   0.00 %
 K-hv2  72.8 keV  23.71 %   0.00 %
 K-hv3  84.9 keV  15.66 %   0.00 %
 K-hv4  84.4 keV   7.93 %   0.00 %
 K-hv5  87.3 keV   6.52 %   0.00 %
 K-hv6  85.5 keV   0.47 %   0.00 %
 K-hv7  87.6 keV   0.15 %   0.00 %
 K-hv8  72.1 keV   2.55 %   0.00 %
------------------------------------------------------------------------------
 SCATTER IN ENERGY WINDOW
 Scatter/Primary....: 0.26532        
 Scatter/Total......: 0.20969        
 Scatter order 1....: 84.69 %        
 Scatter order 2....: 13.27 %        
 Scatter order 3....: 1.79 %         
 Scatter order 4....: 0.25 %         
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0442         
 Efficiency spectrum: 0.4197         
 Sensitivity Cps/MBq: 80.2251        
 Sensitivity Cpm/uCi: 178.0996       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:20 19:47:26
 Simulation stopped.: 2024:04:21 15:56:55
 Elapsed time.......: 20 h, 9 m and 29 s
 DetectorHits.......: 4637572        
 DetectorHits/CPUsec: 147            
------------------------------------------------------------------------------
 ...
 Header file: mew15_main.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia mew15_main/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:170.925/21:147.075/bg:0.2
