...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew15_up          
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:   2.12   0.28   0.12   0.05   4.71   6.23   0.34   0.13
 penetration..:   6.17   2.70  50.87  12.07  16.54   7.62  26.60   6.58
 collim scatt.:   4.68   1.81  15.44   3.71  11.19   3.97   8.98   2.32
 collim x-rays:   0.00   0.00   0.00   0.00   3.22   1.56   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 304.3          
 MaxValue projection: 0.3556E-01     
 CountRate spectrum.: 762.6          
 CountRate E-Window.: 48.06          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.23 %           2.56 %
 Penetration........:  62.39 %          71.80 %
 Scatter in collim..:  23.94 %          25.64 %
 X-rays in collim...:   2.44 %           0.00 %
 ...
 K-hv8  72.1 keV   2.32 %   0.00 %
------------------------------------------------------------------------------
 SCATTER IN ENERGY WINDOW
 Scatter/Primary....: 0.25948        
 Scatter/Total......: 0.20602        
 Scatter order 1....: 83.57 %        
 Scatter order 2....: 14.03 %        
 Scatter order 3....: 2.09 %         
 Scatter order 4....: 0.32 %         
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0265         
 Efficiency spectrum: 0.4198         
 Sensitivity Cps/MBq: 48.0612        
 Sensitivity Cpm/uCi: 106.6959       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:22 02:26:27
 Simulation stopped.: 2024:04:22 13:00:14
 Elapsed time.......: 10 h, 33 m and 47 s
 DetectorHits.......: 4637233        
 DetectorHits/CPUsec: 474            
------------------------------------------------------------------------------
 ...
 Header file: mew15_up.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia mew15_up/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:194.775/21:170.925/bg:0.2
