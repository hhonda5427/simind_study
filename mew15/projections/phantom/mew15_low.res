...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew15_low         
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:   3.45  19.35   0.32   0.11   4.71   6.24   0.34   0.13
 penetration..:   5.93   3.24  33.52  10.70  16.54   7.62  26.56   6.58
 collim scatt.:   4.08   1.90  13.09   4.31  11.18   3.98   9.00   2.33
 collim x-rays:   0.00   0.00   0.00   0.00   3.22   1.56   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 304.0          
 MaxValue projection: 0.3924E-01     
 CountRate spectrum.: 762.1          
 CountRate E-Window.: 48.06          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.23 %          23.23 %
 Penetration........:  62.38 %          53.39 %
 Scatter in collim..:  23.95 %          23.38 %
 X-rays in collim...:   2.45 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  43.12 %   0.00 %
 K-hv2  72.8 keV  23.73 %   0.00 %
 K-hv3  84.9 keV  15.74 %   0.00 %
 K-hv4  84.4 keV   8.03 %   0.00 %
 K-hv5  87.3 keV   6.53 %   0.00 %
 K-hv6  85.5 keV   0.46 %   0.00 %
 K-hv7  87.6 keV   0.14 %   0.00 %
 K-hv8  72.1 keV   2.24 %   0.00 %
------------------------------------------------------------------------------
 SCATTER IN ENERGY WINDOW
 Scatter/Primary....: 0.6558         
 Scatter/Total......: 0.39606        
 Scatter order 1....: 74.57 %        
 Scatter order 2....: 20.89 %        
 Scatter order 3....: 3.92 %         
 Scatter order 4....: 0.61 %         
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0265         
 Efficiency spectrum: 0.4196         
 Sensitivity Cps/MBq: 48.0582        
 Sensitivity Cpm/uCi: 106.6891       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:21 15:56:56
 Simulation stopped.: 2024:04:22 02:26:26
 Elapsed time.......: 10 h, 29 m and 30 s
 DetectorHits.......: 4637094        
 DetectorHits/CPUsec: 413            
------------------------------------------------------------------------------
 ...
 Header file: mew15_low.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia mew15_low/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:147.075/21:123.225/bg:0.2
