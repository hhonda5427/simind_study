...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew15_main_cali_sp
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:  43.21   0.00   0.07   0.00  12.45   0.00   0.61   0.00
 penetration..:  14.49   0.00  25.35   0.00  22.24   0.00  34.50   0.00
 collim scatt.:   7.16   0.00   9.72   0.00  14.40   0.00  11.27   0.00
 collim x-rays:   0.00   0.00   0.00   0.00   4.53   0.00   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 931.1          
 MaxValue projection: 6.732          
 CountRate spectrum.: 1172.          
 CountRate E-Window.: 152.8          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:   6.59 %          43.28 %
 Penetration........:  67.42 %          39.84 %
 Scatter in collim..:  23.90 %          16.88 %
 X-rays in collim...:   2.08 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  43.13 %   0.00 %
 K-hv2  72.8 keV  23.75 %   0.00 %
 K-hv3  84.9 keV  15.60 %   0.00 %
 K-hv4  84.4 keV   7.87 %   0.00 %
 K-hv5  87.3 keV   6.40 %   0.00 %
 K-hv6  85.5 keV   0.47 %   0.00 %
 K-hv7  87.6 keV   0.15 %   0.00 %
 K-hv8  72.1 keV   2.64 %   0.00 %
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.053          
 Efficiency spectrum: 0.4066         
 Sensitivity Cps/MBq: 152.8143       
 Sensitivity Cpm/uCi: 339.2477       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:22 13:06:14
 Simulation stopped.: 2024:04:22 15:30:20
 Elapsed time.......: 2 h, 24 m and 6 s
 DetectorHits.......: 1773138        
 DetectorHits/CPUsec: 801            
------------------------------------------------------------------------------
 ...
 Header file: mew15_main_cali_sp.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Command: symbia mew15_main_cali_sp/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:170.925/21:147.075/15:5/fa:11
