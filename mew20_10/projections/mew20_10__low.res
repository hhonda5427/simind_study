...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: mew20_10__low     
...
------------------------------------------------------------------------------
 ...
 LowerEneWindowTresh: 127.2        Random   ShiftSource X.....: 0              
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:   2.27  19.66   0.33   0.11   4.71   6.23   0.34   0.13
 penetration..:   5.72   3.21  34.33  10.81  16.55   7.62  26.59   6.59
 collim scatt.:   3.98   1.92  13.27   4.40  11.19   3.97   8.98   2.33
 collim x-rays:   0.00   0.00   0.00   0.00   3.21   1.57   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 305.2          
 MaxValue projection: 0.2690E-01     
 CountRate spectrum.: 762.4          
 CountRate E-Window.: 31.40          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.23 %          22.37 %
 Penetration........:  62.39 %          54.07 %
 Scatter in collim..:  23.93 %          23.57 %
 X-rays in collim...:   2.45 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  43.02 %   0.00 %
 K-hv2  72.8 keV  23.62 %   0.00 %
 K-hv3  84.9 keV  15.65 %   0.00 %
 K-hv4  84.4 keV   7.96 %   0.00 %
 K-hv5  87.3 keV   6.49 %   0.00 %
 K-hv6  85.5 keV   0.48 %   0.00 %
 K-hv7  87.6 keV   0.15 %   0.00 %
 K-hv8  72.1 keV   2.62 %   0.00 %
------------------------------------------------------------------------------
 SCATTER IN ENERGY WINDOW
 Scatter/Primary....: 0.66959        
 Scatter/Total......: 0.40105        
 Scatter order 1....: 74.41 %        
 Scatter order 2....: 21.11 %        
 Scatter order 3....: 3.90 %         
 Scatter order 4....: 0.58 %         
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0173         
 Efficiency spectrum: 0.4199         
 Sensitivity Cps/MBq: 31.3965        
 Sensitivity Cpm/uCi: 69.7003        
------------------------------------------------------------------------------
 Simulation started.: 2024:04:27 09:53:29
 Simulation stopped.: 2024:04:27 22:00:27
 Elapsed time.......: 12 h, 6 m and 58 s
 DetectorHits.......: 4635049        
 DetectorHits/CPUsec: 328            
------------------------------------------------------------------------------
 ...
 Header file: mew20_10__low.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia mew20_10__low/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/20:143.1/21:127.2/bg:0.2
