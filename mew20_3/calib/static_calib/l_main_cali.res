...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: l_main_cali       
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:  38.81   0.00   0.10   0.00  12.43   0.00   0.62   0.00
 penetration..:  13.72   0.00  29.43   0.00  22.16   0.00  34.51   0.00
 collim scatt.:   6.99   0.00  10.95   0.00  14.50   0.00  11.30   0.00
 collim x-rays:   0.00   0.00   0.00   0.00   4.48   0.00   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 12.81          
 MaxValue projection: 7.209          
 CountRate spectrum.: 1173.          
 CountRate E-Window.: 182.0          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:   6.59 %          38.91 %
 Penetration........:  67.46 %          43.15 %
 Scatter in collim..:  23.94 %          17.95 %
 X-rays in collim...:   2.01 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  44.45 %   0.00 %
 K-hv2  72.8 keV  24.60 %   0.00 %
 K-hv3  84.9 keV  15.78 %   0.00 %
 K-hv4  84.4 keV   7.91 %   0.00 %
 K-hv5  87.3 keV   6.62 %   0.00 %
 K-hv6  85.5 keV   0.44 %   0.00 %
 K-hv7  87.6 keV   0.18 %   0.00 %
 K-hv8  72.1 keV   0.01 %   0.00 %
------------------------------------------------------------------------------
 CALCULATED DETECTOR PARAMETERS
 Efficiency E-Window: 0.0631         
 Efficiency spectrum: 0.4066         
 Sensitivity Cps/MBq: 181.9697       
 Sensitivity Cpm/uCi: 403.9728       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:15 20:18:52
 Simulation stopped.: 2024:04:15 20:20:50
 Elapsed time.......: 0 h, 1 m and 58 s
 DetectorHits.......: 1775922        
 DetectorHits/CPUsec: 30188          
------------------------------------------------------------------------------
 ...
 Header file: l_main_cali.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Command: symbia l_main_cali/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/29:1/15:5/fa:11
