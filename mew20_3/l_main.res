...
------------------------------------------------------------------------------
 ...
 Phantom(B): h2o       BackScatt.: pmt       OutputFile: l_main            
...
PENETRATE ROUTINE -   B=BackScatter, P=PhantomScatter
 ...
 geometric....:  25.01   6.72   0.07   0.04   4.72   6.23   0.34   0.13
 penetration..:  10.11   2.43  26.54   8.68  16.55   7.61  26.58   6.57
 collim scatt.:   5.43   1.35  10.42   3.20  11.18   3.98   8.99   2.33
 collim x-rays:   0.00   0.00   0.00   0.00   3.22   1.57   0.00   0.00
------------------------------------------------------------------------------
 INTERACTIONS IN THE CRYSTAL
 MaxValue spectrum..: 304.8          
 MaxValue projection: 0.6256E-01     
 CountRate spectrum.: 762.3          
 CountRate E-Window.: 98.71          
------------------------------------------------------------------------------
 PHOTONS AFTER COLLIMATOR AND WITHIN ENER-WIN
 Geometric..........:  11.22 %          31.84 %
 Penetration........:  62.39 %          47.77 %
 Scatter in collim..:  23.93 %          20.39 %
 X-rays in collim...:   2.46 %           0.00 %

 K-edge 87.6 keV
 K-hv1  75.0 keV  42.94 %   0.00 %
 K-hv2  72.8 keV  23.61 %   0.00 %
 K-hv3  84.9 keV  15.69 %   0.00 %
 K-hv4  84.4 keV   7.97 %   0.00 %
 K-hv5  87.3 keV   6.46 %   0.00 %
 K-hv6  85.5 keV   0.47 %   0.00 %
 K-hv7  87.6 keV   0.15 %   0.00 %
 K-hv8  72.1 keV   2.72 %   0.00 %
------------------------------------------------------------------------------
 SCATTER IN ENERGY WINDOW
 Scatter/Primary....: 0.28907        
 Scatter/Total......: 0.22425        
 Scatter order 1....: 84.03 %        
 Scatter order 2....: 13.80 %        
...
------------------------------------------------------------------------------
 ...
 Sensitivity Cps/MBq: 98.7093        
 Sensitivity Cpm/uCi: 219.1346       
------------------------------------------------------------------------------
 Simulation started.: 2024:04:11 06:30:01
 Simulation stopped.: 2024:04:11 17:21:25
 Elapsed time.......: 10 h, 51 m and 24 s
 DetectorHits.......: 4636680        
 DetectorHits/CPUsec: 209            
------------------------------------------------------------------------------
 ...
 Header file: l_main.h00
 Flat-to-Flat 45 degrees rotated for hex hole
 Inifile: simind.ini
 Message: Input file used is:symbia.inp                                        
 Command: symbia l_main/fi:i123/fe:symbia.erf/CC:sy-lehr/53:1/59:1/in:x22,3x/sc:4/bg:0.2
