...
# lower_projections = simind.get_projections(lower_hdr)
# upper_projections = simind.get_projections(upper_hdr)
# ww_peak = simind.get_energy_window_widths(photopeak_hdr)
# ww_lower = simind.get_energy_window_widths(lower_hdr)
# ww_upper = simind.get_energy_window_widths(upper_hdr)
